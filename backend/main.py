...
class MusicGenServer:
    ...
    def generate_categories(self, description: str) -> List[str]:
        prompt = f"Based on the following music description, list 3-5 relevant genres or categories as a comma-separated list. For example: Pop, Electronic, Sad, afrobeat. Description: '{description}'"
...
def main():
    ...
    request_data = GenerateWithDescribedLyricsRequest(
        prompt="pop, happy, upbeat, catchy, vibrant, female vocals, polished vocals",
        described_lyrics="lyrics about Jesus goodness, grace and mercy, power and love",
        guidance_scale=15
    )


    headers = {
        "Modal-Key": "wk-bSkEXSAIPIEr9ZTH38DrLl",
        "Modal-Secret": "ws-RLvLgaG56M3eTttRzGdLPG"
    }
